...
\textbf{1. Tractable - Limited number of predictors, avoids multicolinearity}

2\. Reliable - Provides an estimate of parameter uncertainity

3\. Informative - Allows for interpretation of variable importance
...
1\. Tractable - Limited number of predictors, avoids multicolinearity

\textbf{2. Reliable - Provides an estimate of parameter uncertainity}
...
\textbf{3. Informative - Allows for interpretation of variable importance}
...
Lake TN in highlighted regions were more sensitive to Ag relative to other regions.
\vspace{2em}
...
> Lake TN concentration was strongly related to watershed corn cover and riparian buffer composition.
