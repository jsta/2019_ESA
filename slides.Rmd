...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \pgfsetlinewidth{1ex}
  \pgfpathmoveto{\pgfpoint{7.3cm}{0cm}}
  \pgfpathlineto{\pgfpoint{2.5cm}{0cm}}
  \pgfusepath{stroke}
  \node at (5.1,-0.8) {\textbf{Granularity}};
\end{tikzpicture}
...
\includegraphics[width=11cm]{../../JournalSubmissions/lagos_ag/figures/11_map-1.png} \par
\begin{center}
\includegraphics[width=6cm]{../../JournalSubmissions/lagos_ag/figures/trophic_state-1.png}
\end{center}
