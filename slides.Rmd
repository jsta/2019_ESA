...
\includegraphics[width=3.1cm]{images/crops.png}
\end{column}
...
\end{columns}
\tiny
\hspace{5em}[@danielInfluencesSpatialScale2010]
...
\textbf{Are more granular measures of Ag activity related to lake water quality (TN, TP) across hundreds of lakes and their watersheds?}

\vspace{1em}

\begin{figure}
\includegraphics[width=9cm]{../../JournalSubmissions/lagos_ag/figures/11_map-1.png}
\end{figure}
