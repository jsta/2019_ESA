...
<!-- \draw [step=1.0,blue, very thick] (-4,-4) grid (2,2); -->
  ...
  \node[rotate=90] at (-0.5,-3.3) {\footnotesize Poorly Buffered};
  \draw[decoration={brace,mirror,raise=5pt,amplitude=0.3cm},decorate,line width=0.6mm]
  (0.3,-2.6) -- (0.3,-4);
  \end{tikzpicture}
...
Baseflow and Max depth had a strong influence on predicted TP concentrations.
...
Buffer Ag land use cover had the strongest influence on predicted TN concentrations.
