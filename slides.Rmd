...
\item \begin{tabular}{cc}
        ...
        \end{tabular}
\item \begin{tabular}{cc}
\raisebox{-.5\height}{\includegraphics[width=0.08\paperwidth]{images/buffer_key}} & Buffer composition - Land-use cover - Specific crops, etc.
\end{tabular}
\item \begin{tabular}{cc}
...
## Methods - Regionally varying predictors
\small
...
Buffer Ag land had a stronger influence on predicted TN concentrations relative to TP.

\begin{figure}
\includegraphics[height=4.5cm]{../../JournalSubmissions/lagos_ag/figures/fe-1.png}
\end{figure}
...
\begin{figure}
\includegraphics[height=4.5cm]{../../JournalSubmissions/lagos_ag/figures/re-1.png}
\end{figure}
...
> But, specific crop land use and riparian buffer composition was more influential in the lake TN models.
