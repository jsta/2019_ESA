...
\small
\textbf{Model type:} \hspace{29pt} Hierarchical Bayesian\\ ~ \\ \textbf{Response variables:} \hspace{0pt} TP, TN \\ ~ \\ \textbf{Global predictors:} 12 Granular Ag variables\\ \hspace{111pt} 3 Lake and watershed characteristics \\ ~ \\ \textbf{Variable selection:} None (\emph{horseshoe} shrinkage) \\ ~ \\ \textbf{Regional predictors:} 7 Watershed land-use variables \\ ~ \\ \textbf{Model selection:} Cross-validation on watershed land-use
\end{textblock}
