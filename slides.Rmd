...
\centerline{\includegraphics[width=12cm]{images/tn_vs_ag.png}}\hspace*{8cm}
...
\begin{figure}
    \includegraphics[width=8cm]{images/granularity.png}
  \end{figure}
...
## Methods - 500 high Ag lake catchments
\small
...
Lakes have high Ag land use (> 40%)
...
\item \begin{tabular}{cc}
        ...
        \end{tabular}
\item \begin{tabular}{cc}
        \raisebox{-.5\height}{\includegraphics[width=0.08\paperwidth]{images/proxy_key}} & Nutrient proxies - Land use, specific, crops, etc.
        \end{tabular}
\item \begin{tabular}{cc}
\raisebox{-.5\height}{\includegraphics[width=0.08\paperwidth]{images/buffer_key}} & Buffer composition - \emph{Land use}
\end{tabular}
\item \begin{tabular}{cc}
...
\textbf{1. Tractible - Limited number of predictors, avoids multicolinearity}

2\. Informative - Allows for interpretation of variable importance

3\. Reliable - Provides an estimate of parameter uncertainity
...
\alert{Ag land use is a proxy} for many different specific activities which are likely to be regionally variable. \par \vspace{-1em}\tiny[@burcherLANDCOVERCASCADERELATIONSHIPS2007]\small
