...
\textbf{Model type:} \hspace{6pt} Hierarchical Bayesian

\textbf{Predictands:} \hspace{5pt} TP, TN

\textbf{Global predictors:} 12 Granular Ag variables\3 Lake and watershed characteristics

\textbf{Variable selection:} None (horseshoe _shrinkage_ approach)

\textbf{Regionally varying predictors:} Watershed land-use

\textbf{Model selection:} Cross-validation among watershed land-use
