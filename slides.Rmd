...
\begin{figure}
\includegraphics[width=7cm]{../../JournalSubmissions/lagos_ag/figures/11_map-1.png}\hspace{1em}\includegraphics[width=7cm]{../../JournalSubmissions/lagos_ag/figures/trophic_state-1.png}
\end{figure}
